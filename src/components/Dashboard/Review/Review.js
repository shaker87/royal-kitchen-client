        ...
        <div> 
           <Row xs={12}>
                ...
                <div className='d-flex justify-content-between'>
                    ...
                    <h2 className='mt-4 mr-5 display-username-1' style={{fontSize:'16px', fontWeight:'500'}}>User</h2>
                </div>
                        ...
                        <Row xs={10} sm={12} className='p-5'>
                            <Col xs={10} md={12} lg={8}>
                                ...
                                <Form.Group controlId="formBasicDesignation">
                                    <Form.Control  name='designationAndCompany' type="designation" placeholder="Designation, Company name - suppose: CEO, Menpol" />
                                </Form.Group>

                                <Form.Group controlId="exampleForm.ControlTextarea1">
                                    <Form.Control  name='description' as="textarea" rows="5" placeholder='Description'/>
                                </Form.Group>
